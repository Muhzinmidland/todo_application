            ...
            <div className='d-flex align-items-center justify-content-center'>
                <div className='mt-3'>
                    <div>
                        ...
                        type="text" placeholder='Enter Your Task' className='form-control border border-secondary rounded' style={{width:'400px', height:'50px'}} border border-primary/>
                    </div>
                    <div className='mt-3'>
                        <textarea
                        style={{width:'400px'}}
                        ...
                        name="w3review" id="w3review" cols="30" rows="5" className='border-secondary rounded' placeholder='Description'></textarea>
                    </div>
